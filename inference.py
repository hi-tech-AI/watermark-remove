...
parser.add_argument('--image-path', type = str, default = './image.jpg', help = 'Path to the "watermarked" image.')
...
parser.add_argument('--training-steps', type = int, default = 5000, help = 'Number of training iterations.')
parser.add_argument('--show-step', type = int, default = 5000, help = 'Interval for visualizing results.')
